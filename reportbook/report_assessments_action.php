...
if(isset($_POST['yid']) and $_POST['yid']!=''){$yid=$_POST['yid'];$comid='';}
elseif(isset($_POST['formid']) and $_POST['formid']!=''){$comid=$_POST['formid'];$yid='';}
elseif(isset($_POST['houseid'])  and $_POST['houseid']!=''){$comid=$_POST['houseid'];$yid='';}
