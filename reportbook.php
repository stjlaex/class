...
<?php
	...
	$rhouses=array();
	$ryids=array();
	if($r>-1 and $current!='report_reports.php' and $current!='report_attendance.php' 
	   and $current!='report_merits.php' and $current!='report_comments.php' and $current!='report_incidents.php'){
