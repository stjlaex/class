...
$string['classblurb']='Classis (the Classis Student System) is a complete student tracking, reporting and information management system. Classis aims to be the ubiquitous classroom information assistant for schools.';
$string['formoreinformation']='For more information on how to use Classis, how you can contribute to improving Classis and to discover how Classis can make a difference to the learning in your school, then take a look at the Classis homepage.';
