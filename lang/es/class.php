...
$string['classesandmarks']='Clases et Marcas';
$string['classarea']='ClaSS &Aacute;rea restricta';
$string['enter']='Entr&eacute;';
$string['no']='No';
$string['password']='Contrase&ntilde;a';
$string['username']='Nombre d\'usuario';
$string['yes']='Si';
...
$string['newestimates']='New estimates';
...
$string['collatecommentssince']='Collate comments since';
...
$string['retypenewpassword']='Retype new password';
...
$string['seperateprintwindow']='A sperate preview window will open in a moment';
...
$string['emailfooterdisclaimer']='		
		This message is confidential. It has been automatially
		...
		from your system once it has been acted upon. Any unauthorized
