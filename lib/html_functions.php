...
?>
	<tr>
	  <td>
<?php
		if(isset($val['label_not_translate']) and $val['label_not_translate']){
?>
...
?>
				...
				<div id="<?php print $commentdataObj['openid'].'-'.$c;?>" class="<?php print $htmleditor;?>"
