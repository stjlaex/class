			...
			if(elementObject.className.indexOf("htmleditorarea")!=-1){
				/*prepares textareas with tinyMCE */
				  tinyMCE.init({
					mode : "textareas",
					theme : "advanced",
					  theme_advanced_buttons1 : "bold,italic,underline,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,bullist,numlist,undo,redo,spellchecker,pastetext,pasteword,selectall", 
