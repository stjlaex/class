...
?>
            <div class="divgroup">
                ...
                <ul class="chk-list">
                    <li class="row <?php if($nextnav=='table'){print 'checked';}?>">
                        <label for="table"><?php print_string('table',$book);?></label>
                        <input type="radio" name="nextnav" title="Table" id="table" value="table" <?php if($nextnav=='table'){print 'checked';}?> />
                    </li>
                    <li class="row <?php if($nextnav=='student'){print 'checked';}?>">
                        <label for="student"><?php print_string('student',$book);?></label>
                        <input type="radio" name="nextnav" title="Student" id="student" value="student" <?php if($nextnav=='student'){print 'checked';}?> />
                    </li>
                    <li class="row <?php if($nextnav=='component'){print 'checked';}?>">
                        <label for="component"><?php print_string('component',$book);?></label>
                        <input type="radio" name="nextnav" title="Component" id="component" value="component" <?php if($nextnav=='component'){print 'checked';}?> />
                    </li>
                </ul>
            </div>
<?php
